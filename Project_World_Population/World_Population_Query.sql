...
-- 10. How many countries do we have to add their populations to get the same number as the populations of China and India combined?
...
FROM
    country
        JOIN
    population ON population.country_id = country.Country_id;
